...
const showDiscord = window.location.host.search('validatornode.com') > -1;
    ...
    >
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          ...
          <h1 class="flex-1 ml-3 text-2xl font-semibold dark:text-white" style="font-size: 1.3rem;">
            ValidatorNode
          </h1>
        </RouterLink>
        <div
      ...
      <div class="px-2">
        ...
        <a
          href="https://ourlink.net"
          target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]"
        >
          <img
            src="/logos/ourlink.png"
            class="w-6 h-6 rounded-full mr-3"
          />
          <div
        ...
        <a
          href="https://twitter.com/validatornode"
          target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]"
        >
        ...
        <a
          v-if="showDiscord"
          href="https://discord.com/invite/2G9ymd6c43"
          target="_blank"
